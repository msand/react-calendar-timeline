...
function (_Component) {
  ...
  _createClass(Sidebar, [{
    ...
    value: function componentDidMount() {
      ...
      var isRightSidebar = this.props.isRightSidebar;
      (0, _interactjs["default"])(this.ref.current).resizable({
        edges: {
          left: isRightSidebar,
        ...
        if (_this2.state.resizing) {
          if (_this2.props.onResizeSidebar) {
            _this2.props.onResizeSidebar(isRightSidebar, e.pageX);
          }
        }
