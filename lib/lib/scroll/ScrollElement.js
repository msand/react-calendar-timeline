...
function (_Component) {
  ...
  function ScrollElement() {
    ...
    _defineProperty(_assertThisInitialized(_this), "resize", null);

    _defineProperty(_assertThisInitialized(_this), "handleMouseDown", function (e) {
      if (e.target.className === 'rct-sidebar-resize') {
        _this.resize = e.target.classList.contains('rct-sidebar-resize-right');
        return;
      }
    ...
    _defineProperty(_assertThisInitialized(_this), "handleMouseMove", function (e) {
      ...
      if (_this.resize !== null) {
        _this.props.onResizeSidebar(_this.resize, e.pageX);
...
_defineProperty(ScrollElement, "propTypes", {
  ...
  onResizeSidebar: _propTypes["default"].func.isRequired
});
