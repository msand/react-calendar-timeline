...
function (_React$PureComponent) {
  ...
  function SidebarHeader() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getRootProps", function () {
      ...
      var isRight = _this.props.variant === _constants.RIGHT_VARIANT;
      var width = isRight ? _this.props.rightSidebarWidth : _this.props.leftSidebarWidth;
      return {
        style: _objectSpread((_objectSpread2 = {
          zIndex: 1,
          position: 'sticky'
        }, _defineProperty(_objectSpread2, isRight ? 'right' : 'left', 0), _defineProperty(_objectSpread2, "minWidth", width), _objectSpread2), style, {
          width: width
        })
      };
    });
